...
import { getAllApplicants } from 'service/endPoints'
...
export const ApplicantsTable = ({ searchedData, filteredByStatus }: Props) => {
    ...
    }, [data, searchedData, filteredByStatus]) as
        | AxiosResponse<Applicant[]>
        | undefined
